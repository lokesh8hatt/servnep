    ...
    categories: [
      {
        ...
        items: [
          ...
          { name: 'Toilet Flush Repair', description: 'Fixing flush tank leakage or mechanism replacement.', basePrice: 500, durationMins: 45 },
          { name: 'Drain Unclogging', description: 'Clearing blockages in kitchen sink or bathroom drain.', basePrice: 650, durationMins: 60 },
        ],
      },
      {
        ...
        items: [
          { name: 'Underground Tank Cleaning (up to 5000L)', description: 'Manual cleaning, scrubbing, and UV disinfection.', basePrice: 3000, durationMins: 120 },
          { name: 'Overhead Tank Cleaning (up to 1000L)', description: 'Scrubbing and disinfection of black plastic tanks.', basePrice: 1500, durationMins: 90 },
        ],
      },
    ],
  },
    ...
    categories: [
      {
        ...
        items: [
          { name: 'Switch/Socket Replacement', description: 'Replace broken switch board switches or sockets.', basePrice: 350, durationMins: 15 },
          { name: 'Ceiling Fan Installation', description: 'Assembling and mounting ceiling fan with regulator connection.', basePrice: 600, durationMins: 45 },
          { name: 'Short Circuit Diagnostic', description: 'Troubleshooting electrical trip issues in house distribution board.', basePrice: 750, durationMins: 60 },
        ],
      },
    ],
  },
    ...
    categories: [
      {
        ...
        items: [
          { name: 'Split AC Servicing', description: 'Cleaning indoor/outdoor coils, filter cleaning, and diagnostics.', basePrice: 1600, durationMins: 60 },
          { name: 'AC Gas Refill', description: 'Gas pressure check and complete refilling.', basePrice: 5000, durationMins: 90 },
        ],
      },
    ],
  },
    ...
    categories: [
      {
        ...
        items: [
          { name: '1 BHK Deep Cleaning', description: 'Complete deep cleaning of bedroom, kitchen, hall and bathroom.', basePrice: 5500, durationMins: 240 },
          { name: '2 BHK Deep Cleaning', description: 'Deep scrubbing, glass window cleaning and sanitization.', basePrice: 7500, durationMins: 300 },
          { name: 'Sofa Dry Cleaning (per seat)', description: 'Vacuuming, shampoo scrubbing, and wet drying.', basePrice: 300, durationMins: 30 },
        ],
      },
      {
        name: 'Pest Control',
        ...
        items: [
          { name: 'Standard Cockroach Treatment', description: 'Eco-friendly herbal gel treatment for kitchen and bathrooms.', basePrice: 3000, durationMins: 90 },
        ],
      },
    ],
  },
    ...
    categories: [
      {
        ...
        items: [
          { name: 'Interior Wall Painting (per room)', description: 'Two-coat emulsion painting for a single room including basic surface preparation.', basePrice: 4000, durationMins: 180 },
          { name: 'Exterior Wall Painting (per 1000 sq.ft)', description: 'Weatherproof exterior emulsion painting with a primer coat.', basePrice: 28000, durationMins: 480 },
          { name: 'Textured Wall Finish (per wall)', description: 'Decorative textured finish application for a single feature wall.', basePrice: 8000, durationMins: 120 },
          { name: 'Waterproof Coating (per 100 sq.ft)', description: 'Application of waterproof membrane coating on roof or wall surfaces.', basePrice: 3500, durationMins: 90 },
          { name: 'Wall Crack Filling & Putty', description: 'Filling minor cracks and applying wall putty before painting.', basePrice: 1000, durationMins: 60 },
        ],
      },
    ],
  },
